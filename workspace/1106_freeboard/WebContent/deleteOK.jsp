...
<%
//	한글 깨짐 방지하고 delete.jsp에서 넘어오는 데이터를 받는다.
...
//	삭제할 글의 비밀번호와 삭제하기 위해 입력한 비밀번호를 비교하기 위해 삭제할 글 한 건을 얻어온다.
	FreeboardVO original = service.selectByIdx(vo.getIdx());
//	삭제할 글의 비밀번호와 삭제하기 위해 입력한 비밀번호를 비교해서 같으면 글을 삭제한 후 목록으로 돌아가고 같지 않으면 비밀번호가
